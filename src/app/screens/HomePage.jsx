          ...
          <Row>
            <Col md={12}>
              <ul>
                ...
                <li className="wow zoomIn" data-wow-delay="1.0s">
                  {t("enterprises")}
                </li>
                <li className="wow zoomIn" data-wow-delay="1.1s">
                  {t("ED-TECH")}
                </li>
                <li className="wow zoomIn" data-wow-delay="1.2s">
                  {t("E-COMMERCE")}
                </li>
                <li className="wow zoomIn" data-wow-delay="1.3s">
                  {t("Health-tech")}{" "}
                </li>
                <li className="wow zoomIn" data-wow-delay="1.4s">
                  {t("Tourism")}
                </li>
                <li className="wow zoomIn" data-wow-delay="1.5s">
                  {t("Gaming")}
                </li>
              </ul>
            </Col>
          ...
          <Row>
            <Col md={12} className="text-center">
              ...
              <div className="ProgressTitle">
                ...
                <a href="#" className="c-button fillBtn Green">
                  {t("Get Started")}
                </a>
              </div>
              ...
              <div className="ProgressContent">
                <ul>
                  ...
                  <li className="two wow zoomInRight" data-wow-delay="0.5s">
                    <span className="">
                      {t("Empowering AI at Your Fingertips")}
                    </span>
                  </li>
            ...
            <Col md={12} className="text-center">
              <div className="wpb_wrapper">
                ...
                <div className="ProcessTitle">
                  <h3>
                    {t("Power up Business")} <br /> {t("Growth")}
                  </h3>
                </div>
              ...
              <div className="ProcessWrap">
                <div className="BlockContent">
                  ...
                  <div className="ProccessContent right">
                    <h3 className="wow fadeInRight" data-wow-duration="0.5s">
                ...
                <div className="BlockContent">
                  <div className="ProccessContent left">
                    <h3 className="wow fadeInLeft" data-wow-duration="0.5s">
                      {t("Development")}
                    </h3>

                    <p className="wow fadeInLeft" data-wow-duration="0.5s">
                      {t(
        ...
        <Container>
          <Row>
            <Col md={12} className="text-center mb-4">
              <h2 className="Title wow fadeInUp">{t("WHAT'S NEW")}fdsafs</h2>
            </Col>
          </Row>
        ...
        <Container>
          <Row>
            <Col md={12}>
              ...
              <a href="#" className="c-button fillBtn">
                {t("Contact Team")}
              </a>
            </Col>
          </Row>
