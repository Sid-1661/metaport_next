    ...
    <>
          ...
          <Row>
            ...
            <Col md={8}>
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="c-button fillBtn w-100">
                  {t("Send")}
                </button>
              </form>
            </Col>
      ...
      <div className={Styles.AddressWrap}>
        <Container>
          <Row className={Styles.FlexRow}>
            <Col
              md={4}
              className={`${Styles.InfoWidget} text-center InfoWidget`}
            >
              <Image
            ...
            <Col md={4}>
              <div className={Styles.addressInfo}>
                ...
                <p>
                  {t("Unit 1, Level G, Emirates Towers Boulevard, Dubai, UAE")}
                </p>
              </div>
            </Col>
            <Col md={4}>
      ...
      <div className={`${Styles.mapWrap}`}>
        <Container>
          <Row>
            <Col md={12}>
              <img src="/images/map.png" width={1448} height={586} alt="Map" />
            </Col>
          </Row>
        </Container>
      </div>
